...
topK=0.05;
edge.cut=12;
(files=Sys.glob(paste0('../brain_scRNA-seq_n15c0.005_bigScale2/top_*_pan.rds')))
...
## choose edge commonality cutoff to characterize core
      ...
      sum(pan.genes %in% gene.age$SYMBOL) # 2002 common.expr
      ...
      pdf(paste0('./top_',topK,'_edge.cut',edge.cut,'_gene.age_coreVSnot.core.pdf'),
