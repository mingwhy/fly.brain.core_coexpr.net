...
path.shuffle='./brain_scRNA-seq_n15c0.005_bigScale2/net_rewire_rep100/';
...
pdf(paste0(out.dir,'/edge.common_obs_vs_simu_',topK,'.pdf'),
    useDingbats = T,width=7,height = 3)
#print(plots1[[1]]);print(plots2[[1]])
print(plots2[[1]]+ggtitle('')+ theme_bw(base_size = 8)+
