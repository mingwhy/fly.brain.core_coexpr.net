...
edge.i=11;sample.nedge.for.this.group=100; #cocaine brain
  #edge.group=val.mat[commonality==edge.i,,drop=F]
  edge.group=val.mat[commonality>=edge.i,,drop=F]
  dim(edge.group) #105 edges, 0/1 binary matrix, n.edge X n.cell.cluster
  ...
  pdf(paste0('./body_top0.05_edge_',edge.i,'.pdf'),width=14,height = 8)
  pheatmap(t(df.out),
           color = my.colors,
           breaks = my.breaks,
