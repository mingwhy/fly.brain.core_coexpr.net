...
length(table(dat@meta.data$annotation)) #38
...
length(all.genes) #7795, 8867
length(common.genes) #2088, 842
...
#sc: 38 cluster. 37 in female, 31 in male.
#sn: 40 cluster. 40 in female, 36 in male.
