...
#edge.i=43;sample.nedge.for.this.group=100; #sc
#edge.i=12;sample.nedge.for.this.group=100; #sn
edge.i=50;sample.nedge.for.this.group=100; #sn
  ...
  dim(df.out) #sc, 100edge x 67 cell cluster. sn,21edge X 76 cell types
  ...
  my.colors[length(my.breaks)-1]='grey'
  
  #pdf(paste0('./sc_top0.05_edge_',edge.i,'.pdf'),width=24,height = 14)
