...
max(commonality) #sn 33
table(commonality)
length(commonality) #354061 number of edges per network

edge.i=6;sample.nedge.for.this.group=100; #sc
#edge.i=22;sample.nedge.for.this.group=100; #sn
