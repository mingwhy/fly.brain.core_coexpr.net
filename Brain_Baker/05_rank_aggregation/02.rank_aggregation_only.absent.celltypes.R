...
sample.nedge=100;
edge.groups=seq(1,100,2) #sn_FCA_body
...
file='../brain_scRNA-seq_n15c0.005_bigScale2/top_0.05_networks_cutoff_cell.type.rds'
...
dim(cor.rank.df) #47 1509453 # #cluster X #edge
