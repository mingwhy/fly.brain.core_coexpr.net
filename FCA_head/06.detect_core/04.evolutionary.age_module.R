...
cut=43
gene.module.info=data.table::fread(paste0(out.dir,'cut',cut,'_gene_module.txt'));
# 189 genes have a module membership
...
pdf(paste0(out.dir,'cut',cut,'_MCL_modules_age.pdf'),height = 9,width = 14)
