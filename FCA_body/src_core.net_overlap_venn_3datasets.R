...
##
datasets=c('body, Li et al. 2022','head, Li et al. 2022',
           'brain, Davie et al. 2018','brain, Baker et al. 2021')

library(gplots)
pdf('core.net_overlap_venn_3datasets.pdf',useDingbats = T,height = 11)
par(mfrow=c(2,1),mar=c(0,0,0,0))
my.gene.sets<-list('brain, Davie et al. 2018'=gene1,'body, Li et al. 2022'=gene2,
                   'brain, Baker et al. 2021'=gene3)
v.genes<-venn(my.gene.sets)
text(200,400,'Venn diagram of core genes',cex=2)
#title='Venn diagram of shared core genes'

my.edge.sets<-list('brain, Davie et al. 2018'=edges1,'body, Li et al. 2022'=edges2,
                   'brain, Baker et al. 2021'=edges3)
v.edges<-venn(my.edge.sets)
text(200,400,'Venn diagram of shared core edges',cex=2)
dev.off()
