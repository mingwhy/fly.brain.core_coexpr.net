...
x=unlist(read.table('../02_choose_top.percentage_threshold/sc_keep.cell.types.txt',sep='\n'))
length(x) #47
...
topK='top_0.05';
input.dir='../brain_scRNA-seq_n15c0.005/bigScale2_coexpr/';
out.dir='./';
