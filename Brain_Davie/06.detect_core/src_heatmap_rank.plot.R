...
file='../05.rank_aggregation/cor.rank.list.rds'
...
edge.list=readRDS('../05.rank_aggregation/top_0.05_edge_in.cell.types.rds');
...
edge.i=12;sample.nedge.for.this.group=100; #sn
  ...
  pdf(paste0('./sc_top0.05_edge_',edge.i,'.pdf'),width=14,height = 10)
  pheatmap(t(df.out),
           color = my.colors,
           breaks = my.breaks,
